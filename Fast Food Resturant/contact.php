            ...
            <div class="container">
                ...
                <?php if ($result->num_rows > 0) { ?>
                    <?php while ($row = $result->fetch_assoc()) { 
                        ...
                        function convertToEmbedLink($mapLink) {
                            if (strpos($mapLink, '/maps/place/') !== false) {
                                $mapLink = str_replace('/maps/place/', '/maps/embed/v1/place?key=YOUR_API_KEY&q=', $mapLink);
                            }
                            return $mapLink;
                        }
...
<td>
    <?php 
                        ...
                        $embedLink = convertToEmbedLink($row['googlemap']);
                        
   
    if (!empty($row['googlemap'])): 
        
        $embedLink = htmlspecialchars($row['googlemap']);
    ?>
        <iframe 
            src="<?= $embedLink ?>" 
    ...
    <?php else: ?>
        <p style="color: red; text-align: center;">No map available</p>
    <?php endif; ?>
</td>
                    ...
                    <div class="col-md-6">
                        <form action="" method="POST">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                <a href="profile.php" class="btn btn-primary w-100 py-3">Send Message</a>
                                </div>
                            </div>
                        </form>
